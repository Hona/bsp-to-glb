...
| Versioned decal/overlay sidecar with static `infodecal` projection and per-record coverage | Supported |
| Universal compiled-overlay geometry parity | Detected only |
| Cubemap detection | Detected only |
...
| Material texture manifest | 2 |
| Visibility sidecar | 2 |
| Entity graph sidecar | 1 |
| Decal and overlay sidecar | 1 |
