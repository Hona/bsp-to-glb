            ...
            if is_displacement {
                primitives_json.push(json!({
                    ...
                    "extras": {
                        ...
                        "bspDispInfoIndices": primitive.dispinfo_indices,
                        "bspDisplacementPowers": primitive.displacement_powers,
                        "bspDisplacementContents": primitive.displacement_contents,
                        "bspDisplacementTriangleTags": primitive.displacement_triangle_tags,
                        "bspDisplacementSourceTriangleTags": primitive.displacement_source_triangle_tags,
